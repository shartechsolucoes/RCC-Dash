  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      formData: {
        ...
        encontrosAnteriores: {
          resgataMe: form.get("resgataMe") === "on",
          resgatao: form.get("resgatao") === "on",
          resgataMeConjugal: form.get("resgataMeConjugal") === "on",
          outros: form.get("outrosEncontros") === "on",
          outrosQual: get("outrosEncontrosQual"),
          nenhum: form.get("nenhumEncontro") === "on",
        },
      },
    };
